...
const tuesday = (time) => 
{
    let tuesdayArr = ['1', '12', '72', '14', '62', '58',' 2', '53',' 6', '55', '58', '13', '56', '58',' 2', '15',' 1', '53', '14', '56', '43', '60', '13', '61', '35', '58', '58', '11', '76', '51', '66',' 1', '32', '58', '58', '58',' 2', '64', '58',' 6', '14', '58', '58', '27', '56', '40', '67', '53', '1', '37', '61', '31', '35', '13', '26', '14', '58', '58', '56', '11', '51', '53', '24',]
    let currShow;
    ...
    else if(time>=20.30&&time<21)         {currShow=58}
    else if(time>=21&&time<21.15)         {currShow=55}
    else if(time>=21.15&&time<22)         {currShow=56}
