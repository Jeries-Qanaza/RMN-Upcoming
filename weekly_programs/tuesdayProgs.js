...
const tuesday = (time) => {
    let tuesdayArr = ['1', '12', '72', '14', '62', '58', '2', '53', '6', '55', '19', '13', '56', '58', '2', '15', '1', '53', '14', '43', '18', '60', '13', '61', '35', '79', '58', '77', '11', '56', '58', '51', '58', '1', '32', '78', '58', '77', '19', '2', '64', '58', '6', '14', '58', '27', '56', '40', '79', '53', '1', '37', '61', '31', '35', '13', '26', '14', '79', '77', '19', '72', '11', '51', '53', '24'];
    let currShow = 0; 
    ...
    else if (time >= 9.15 && time < 9.30) { currShow = 27; }
    ...
    else if (time >= 19.30 && time < 20) { currShow = 56; }
    ...
    else if (time >= 23.45 && time < 24) { currShow = 67; }
