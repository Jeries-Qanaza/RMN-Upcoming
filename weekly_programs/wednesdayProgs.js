...
{
     let wednesdayArr =['1','32','40','63','51','67','53','6','54','19','13','56','65','2','15','1','53','14','56','43','60','13','61','35','69','54','1','18','1','37','56','42','19','30','58','6','14','54','64','66','56','69','70','53','1','12','2','27','35','13','26','14','56','30','19','72','28','61','53','24']
     let currShow;
    ...
    else if(time>=10&&time<10.15)       {currShow=26}
    else if(time>=10.15&&time<10.45)    {currShow=27}
    else if(time>=10.45&&time<11)       {currShow=28}
    else if(time>=11&&time<12)          {currShow=29}
    else if(time>=12&&time<12.15)       {currShow=30}
	else if(time>=12.15&&time<13)       {currShow=31}
    else if(time>=13&&time<13.15)       {currShow=32}
	else if(time>=13.15&&time<13.30)    {currShow=33}
    else if(time>=13.30&&time<14)       {currShow=34}
    else if(time>=14&&time<14.15)       {currShow=35}
    else if(time>=14.15&&time<14.45)    {currShow=36}
    else if(time>=14.45&&time<15)       {currShow=37}
