...
const thursday = (time) => {
    let thursdayArr = ['1', '32', '72', '14', '69', '77', '53', '6', '58', '19', '13', '27', '58', '2', '15', '1', '53', '14', '43', '18', '60', '13', '61', '35', '79', '58', '30', '56', '58', '51', '58', '1', '43', '78', '58', '19', '2', '64', '58', '6', '14', '58', '31', '58', '77', '79', '53', '1', '37', '61', '62', '35', '13', '26', '14', '79', '63', '19', '72', '69', '51', '53', '24'];
    let currShow = 0; 
...
else if (time >= 4.30 && time < 5) { currShow = 12; }
else if (time >= 5 && time < 5.30) { currShow = 13; }
...
else if (time >= 9.15 && time < 10) { currShow = 25; }
else if (time >= 10 && time < 10.30) { currShow = 26; }
else if (time >= 10.30 && time < 10.45) { currShow = 27; }
else if (time >= 10.45 && time < 11) { currShow = 28; }
else if (time >= 11 && time < 11.30) { currShow = 29; }
else if (time >= 11.30 && time < 12) { currShow = 30; }
else if (time >= 12 && time < 12.15) { currShow = 31; }
else if (time >= 12.15 && time < 13) { currShow = 32; }
else if (time >= 13 && time < 13.15) { currShow = 33; }
else if (time >= 13.15 && time < 13.30) { currShow = 34; }
else if (time >= 13.30 && time < 14) { currShow = 35; }
else if (time >= 14 && time < 14.15) { currShow = 36; }
else if (time >= 14.15 && time < 14.45) { currShow = 37; }
else if (time >= 14.45 && time < 15) { currShow = 38; }
...
else if (time >= 19 && time < 19.15) { currShow = 50; }
else if (time >= 19.15 && time < 19.45) { currShow = 51; }
else if (time >= 19.45 && time < 20) { currShow = 52; }
else if (time >= 20 && time < 20.30) { currShow = 53; }
else if (time >= 20.30 && time < 21) { currShow = 54; }
else if (time >= 21 && time < 21.15) { currShow = 55; }
else if (time >= 21.15 && time < 21.30) { currShow = 56; }
else if (time >= 21.30 && time < 22) { currShow = 57; }
else if (time >= 22 && time < 22.15) { currShow = 58; }
else if (time >= 22.15 && time < 22.30) { currShow = 59; }
else if (time >= 22.30 && time < 23) { currShow = 60; }
else if (time >= 23 && time < 23.30) { currShow = 61; }
else if (time >= 23.30 && time < 23.45) { currShow = 62; }
else if (time >= 23.45 && time < 24) { currShow = 63; }

    for (let i = currShow+1; i < thursdayArr.length; i++) {
        ...
        showName.innerHTML = dataPrograms.find(x => x.id == thursdayArr[i]).progName

        //show image
        const showImage = document.createElement("img")
        showImage.className = "showIm"
        showImage.src = dataPrograms.find(x => x.id == thursdayArr[i]).progImg
