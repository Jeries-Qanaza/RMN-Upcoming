...
const saturday = (time) => {
    ...
    else if (time >= 7.15 && time < 7.30) { currShow = 20; }
    else if (time >= 7.30 && time < 7.45) { currShow = 21; }
    ...
    else if (time >= 10.30 && time < 11) { currShow = 30; }
    ...
    else if (time >= 15.30 && time < 16.30) { currShow = 44; }
    ...
    else if (time >= 19 && time < 19.15) { currShow = 52; }
    else if (time >= 19.15 && time < 19.45) { currShow = 53; }
    else if (time >= 19.45 && time < 20) { currShow = 54; }
    else if (time >= 20 && time < 20.30) { currShow = 55; }
    else if (time >= 20.30 && time < 21) { currShow = 56; }
    else if (time >= 21 && time < 21.15) { currShow = 57; }
    else if (time >= 21.15 && time < 22) { currShow = 58; }
    else if (time >= 22 && time < 22.15) { currShow = 59; }
    else if (time >= 22.15 && time < 23) { currShow = 60; }
